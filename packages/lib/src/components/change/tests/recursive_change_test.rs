...
mod tests {
    use crate::{
        components::{
            change::recursive_change::RecursiveChange, component_context::ComponentContext,
            stoch::recursive_stoch::RecursiveStoch, testing::ComponentTestSnapshot,
        },
        ta::{
    ...
    fn _test(cctx: &mut ComponentContext, target: &mut RecursiveChange, expected: &[Option<f64>]) {
