...
mod tests {
    ...
    fn test_rma_btc_1d_length3_close() {
        let (_df, ctx, expected) =
            Fixture::load("ta/moving_average/tests/fixtures/rma/btc_1d_length_3_close.csv");
        _test(
            &mut ctx.clone(),
    ...
    fn test_rma_btc_1d_length7_close() {
        let (_df, ctx, expected) =
            Fixture::load("ta/moving_average/tests/fixtures/rma/btc_1d_length_7_close.csv");
        _test(
            &mut ctx.clone(),
    ...
    fn test_rma_btc_1d_length_14_close() {
        let (_df, ctx, expected) =
            Fixture::load("ta/moving_average/tests/fixtures/rma/btc_1d_length_14_close.csv");
        _test(
            &mut ctx.clone(),
    ...
    fn test_rma_btc_1d_length_350_close() {
        let (_df, ctx, expected) =
            Fixture::load("ta/moving_average/tests/fixtures/rma/btc_1d_length_350_close.csv");
        _test(
            &mut ctx.clone(),
